  ...
  return (
    <div className="animate-fadeUp">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted font-mono text-base tracking-widest uppercase mt-1">
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-warn/5 border border-warn/20 rounded-sm mb-6">
        ...
        <p className="text-warn font-mono text-sm tracking-widest">
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-display font-bold text-text text-base">{deal.name}</p>
                    <p className="text-muted font-mono text-base uppercase tracking-widest">{deal.category}</p>
                  </div>
                </div>
                <div className={clsx("px-2 py-1 rounded-sm border text-[12px] font-mono tracking-widest", risk.color, risk.bg, risk.border)}>
                  {risk.label}
                </div>
              </div>
              ...
              <div className="flex items-end justify-between mb-4">
                <div>
                  <p className="text-muted font-mono text-base uppercase tracking-widest mb-1">Deal Price</p>
                  <p className="font-display font-extrabold text-2xl text-accent">${deal.dealPrice.toFixed(2)}</p>
                  <p className="text-muted font-mono text-base line-through mt-0.5">MSRP ${deal.msrp.toFixed(2)}</p>
                </div>
                <div className="text-right">
                  <p className="text-muted font-mono text-base uppercase tracking-widest mb-1">You Save</p>
                  <p className="font-display font-bold text-lg text-text">${savings.toFixed(2)}</p>
                  <p className="text-accent font-mono text-base">{deal.drop}% off</p>
                </div>
              </div>
