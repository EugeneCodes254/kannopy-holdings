        ...
        <main className="flex-1 p-6 lg:p-8">
          ...
          {activeNav === "dashboard" && (
            selectedProduct ? (
              ...
              <ProductGrid products={products} onSelect={(p) => { setSelectedProduct(p); setActiveNav("dashboard"); }} onAddProduct={() => setShowAddModal(true)} />
            )
          )}
          ...
          {activeNav === "tracking" && (
            selectedProduct ? (
              ...
              <TrackersView products={products} onSelect={(p) => setSelectedProduct(p)} />
            )
          )}
