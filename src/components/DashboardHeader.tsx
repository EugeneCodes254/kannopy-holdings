    ...
    <header className="border-b border-border bg-surface/60 backdrop-blur-sm px-4 sm:px-6 lg:px-8 py-3 sm:py-4 sticky top-0 z-10">
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-muted font-mono text-[9px] sm:text-[10px] tracking-widest uppercase mt-0.5">
            {dateStr}
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-accent text-bg font-display font-bold text-[10px] sm:text-xs tracking-widest uppercase rounded-sm hover:bg-accent/90 active:scale-95 transition-all"
          >
            ...
            {open && (
              <div className="absolute right-0 top-full mt-2 w-40 bg-surface border border-border rounded-sm shadow-xl z-50">
                ...
                <div className="px-3 py-2.5 border-b border-border">
                  <p className="text-text font-mono text-[10px] font-bold truncate">
                    {user?.name}
                  </p>
                  <p className="text-muted font-mono text-[9px] truncate">
                    {user?.email}
                  </p>
                </div>
